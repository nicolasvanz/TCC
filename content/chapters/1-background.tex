...
\begin{figure}[tb]
    \centering%
    \subfloat[modo $1:N$.\label{fig.sync1n}]{%
        \includesvg[width=.48\textwidth]{content/images/sync-1-n.svg}%
    }%
    \quad%
    \subfloat[modo $N:1$.\label{fig.syncn1}]{%
        \includesvg[width=.48\textwidth]{content/images/sync-n-1.svg}%
    }%
...
\begin{figure}[bt]
    \centering
    \includesvg[width=0.6\linewidth]{content/images/mailbox.svg}
...
\begin{figure}[b]
    \centering
    \includesvg[width=0.6\linewidth]{content/images/portal.svg}

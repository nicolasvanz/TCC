...
\begin{enumerate}[label=(\roman*)]
    ...
    \item Todo o sistema de memória está armazenado no \kernel. Tabelas de diretórios, tabelas de página, \tlb, etc.
    \item O sistema de comunicação tem dependências tanto no \kernel quanto a recursos físicos do \cluster. Os identificadores das interfaces \noc \ie de comunicação entre \clusters estão armazenadas em espaço de \kernel e referenciam uma interface física do \cluster em que o processo está executando.
\end{enumerate}

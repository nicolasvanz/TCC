...
\begin{figure}[tb]
	...
	\subcaptionminipage[fig.fork-join]%
                   ...
                   {\includegraphics[width=\textwidth]{content/images/fork-join-kernel-time-bars.pdf}}\label{fig.fork-join}
	\qquad
	\subcaptionminipage[fig.kernel-counters]
                   {.4\textwidth}
                   {Métricas do \kernel.}
                   {\includegraphics[width=\textwidth]{content/images/fork-join-kernel-counters.pdf}}\label{fig.kernel-counters}

...
\begin{inlinelist}
    ...
    \item \mimd.
\end{inlinelist}
Neste trabalho, estamos interessados nas arquiteturas que suportam cargas de trabalho \mimd, as quais ainda podem ser divididas em multiprocessadores ou multicomputadores~\cite{tanenbaum:4ed}, como mostra a \autoref{fig.mimd}.
...
\begin{figure}[t]
    ...
    \caption{(a) multiprocessador de memória compartilhada. (b) multicomputator com troca de mensagens. (c) sistema distribuído de grande escala.}
    \fonte{\cite{tanenbaum:4ed}}
    \label{fig.mimd}
\end{figure}
...
\begin{figure}[bt]
    ...
    \fonte{Adaptado de~\cite{migrationimages}}
\end{figure}

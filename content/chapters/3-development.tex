...
\begin{figure}[t]
    ...
    \subfloat[\os sem isolamento.\label{fig.nanvix.without-uarea}]{%
        \includegraphics[width=.35\textwidth]{content/images/nanvix-without-uarea-uk.pdf}%
    }%
    \quad\quad%
    \subfloat[\os com isolamento.\label{fig.nanvix.with-uarea}]{%
        \includegraphics[width=.35\textwidth]{content/images/nanvix-with-uarea-uk.pdf}%
    }%
    % \vspace{-2mm}

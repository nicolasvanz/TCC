...
\newacronym[longplural={Sistemas Operacionais}]{os}{SO}{Sistema Operational}
...
\newacronym{darpa}{DARPA/IPTO}{Defesa do Governo dos Estados Unidos}
...
\newcommand{\deamons}{\textit{deamons}\xspace}
\newcommand{\libnanvix}{\textit{libnanvix}\xspace}
\newcommand{\ulibc}{\textit{ulibc}\xspace}
\newcommand{\downtime}{\textit{down time}\xspace}
